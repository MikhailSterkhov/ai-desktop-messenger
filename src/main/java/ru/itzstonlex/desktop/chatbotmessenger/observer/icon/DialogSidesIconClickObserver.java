...
public class DialogSidesIconClickObserver extends AbstractFeedFooterIconClickObserver {

  @Override
  protected ImageView findIcon(@NonNull FeedFormFrontView view) {
    return view.find(FeedFormFrontViewConfiguration.ICON_DIALOG_SIDES);
  }

  @Override
  protected void onStateChanged(@NonNull FooterIconsActionsController controller, boolean flag) {
    controller.onDialogSidesStateChanged(flag);
  }
}
